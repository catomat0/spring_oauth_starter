...
public class OahStateService {
    ...
    public OahStateService(RedisTemplate<String, String> redisTemplate, OahProperties properties) {
     ...
     */
    public OahAuthorizeParams issue(String provider) {
        ...
        return OahAuthorizeParams.of(state, codeChallenge);
    }
