 ...
 */
public class OahJwtAuthenticationFilter extends OncePerRequestFilter {

    private static final String BEARER_PREFIX = "Bearer ";

    private final OahJwtProvider jwtProvider;

    public OahJwtAuthenticationFilter(OahJwtProvider jwtProvider) {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if (token != null && jwtProvider.validateAccess(token)) {
            try {
                OahJwtPayload payload = jwtProvider.parseAccess(token);
