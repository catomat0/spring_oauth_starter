 ...
 * <p>{@link com.github.catomat0.oauthhelper.signuptoken.OahSignupTokenCookieWriter} 와 대칭 구조.
 * <p>XSS 로 refresh 토큰 탈취 방어 — body 로 전달하지 말고 이 헬퍼로 쿠키 세팅 권장.
 */
public class OahRefreshTokenCookieWriter {

    private final OahJwtProperties properties;

    public OahRefreshTokenCookieWriter(OahJwtProperties properties) {
    ...
    private ResponseCookie buildCookie(String value, boolean expire) {
        OahJwtProperties.RefreshCookie c = properties.getRefreshCookie();
