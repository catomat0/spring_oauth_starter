...
public class OahJwtProperties {
    ...
    void validate() {
        ...
        if (accessTokenExpiration <= 0) {
            throw new OahJwtException(OahJwtErrorCode.EXPIRATION_INVALID,
        ...
        if ("None".equalsIgnoreCase(refreshCookie.getSameSite()) && !refreshCookie.isSecure()) {
            throw new OahJwtException(OahJwtErrorCode.REFRESH_COOKIE_INSECURE_SAMESITE,
